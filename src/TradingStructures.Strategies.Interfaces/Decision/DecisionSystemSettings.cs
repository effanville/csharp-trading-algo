...
public sealed class DecisionSystemSettings
{
    ...
    public IStockExchange ExchangeHistory { get; }

    public DecisionSystemSettings(DateTime startTime, DateTime burnInEnd, int numberStocks, IStockExchange exchangeHistory)
    {
        StartTime = startTime;
        BurnInEnd = burnInEnd;
