...
namespace TradingSystem.MarketEvolvers
{
    ...
    /// </summary>
    public sealed class EvolverSettings
    {
        /// <summary>
        ...
        /// </summary>
        public EvolverSettings(DateTime startTime, DateTime endTime, TimeSpan evolutionIncrement, IStockExchange exchange, CountryCode countryCode = CountryCode.GB)
        {
            StartTime = startTime;
            EndTime = endTime;
